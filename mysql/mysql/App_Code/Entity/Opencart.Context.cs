...
namespace Entity
{
    ...
    public partial class Opencart : DbContext
    {
        public Opencart()
            : base("name=Opencart")
        {
        ...
        public virtual DbSet<oc_simple_blog_category> oc_simple_blog_category { get; set; }
        public virtual DbSet<oc_simple_blog_category_description> oc_simple_blog_category_description { get; set; }
        public virtual DbSet<oc_soconfig> oc_soconfig { get; set; }
